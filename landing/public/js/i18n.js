...
(function () {
  const DICT = {
    en: {
      ...
      set_sub: 'Same widget, same settings panel — four configurations. Each of these is a real render; tweak the controls and yours updates instantly.',
    ...
    fr: {
      ...
      set_sub: 'Le même widget, le même panneau de réglages — quatre configurations. Chacune est un vrai rendu ; ajustez les options et le vôtre se met à jour instantanément.',
